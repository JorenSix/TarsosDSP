 ...
 */
public class NewSilenceDetector implements NewAudioProcessor {
	 ...
	 */
	public NewSilenceDetector(final double silenceThreshold,boolean breakProcessingQueueOnSilence){
