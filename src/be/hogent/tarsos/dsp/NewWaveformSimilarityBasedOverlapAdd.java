 ...
 */
public class NewWaveformSimilarityBasedOverlapAdd implements NewAudioProcessor {	
	 ...
	 */
	public NewWaveformSimilarityBasedOverlapAdd(Parameters  params){
	...
	public void setDispatcher(NewAudioDispatcher newDispatcher){
