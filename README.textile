...
The sample rate conversion feature is implemented by __Laszlo systems__ in the "libresample4j":https://github.com/dnault-laszlo/libresample4j library. 
...
Included a resample feature, implemented by libresample4j. Together with the WSOLA implementation, it can be used for pitch shifting. A pitch shifting example is added in the 1.4 version of the TarsosDSP library as well. 
