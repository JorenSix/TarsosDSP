...
If you have "Apache Ant":http://ant.apache.org/ and "git":http://git-scm.com/ installed on your system the following code gets you started quickly:
<pre><code>
...
When everything runs correctly you should be able to run all example applications and have the latest version of the Tarsos DSP library for inclusion in your projects. Also the Javadoc documentation for the API should be available in TarsosDSP/doc. Drop me a line if you use TarsosDSP in your project. Always nice to hear how this software is used.
