...
Some information about TarsosDSP can be found in the paper __TarsosDSP, a Real-Time Audio Processing Framework in Java__, by Joren Six, Olmo Cornelis, and Marc Leman, in __Proceedings of the 53rd AES Conference (AES 53rd)__, 2014. If you use TarsosDSP in academic research, please cite this paper.
