...
* @TarsosDSP-Android-x.x-bin.jar@ Jar library for inclusion in Android projects, without source files included.
...
For further information, please consult "TarsosDSP on Android - Audio Processing in Java on Android":http://0110.be/posts/TarsosDSP_on_Android_-_Audio_Processing_in_Java_on_Android. 
